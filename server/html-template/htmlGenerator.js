...
<head>
  ...
  <!-- <script src="instructor.png" defer></script> -->
  <link rel="stylesheet" type="text/css" href="style.css">

  <!-- Title -->
  <!-- <script src="http://3.140.219.139/bundle.js" defer></script> -->
  <!-- <script src="http://localhost:3001/bundle.js" defer></script> -->
  <!-- <script src="http://18.144.174.185/bundle.js" defer></script> -->

  <!-- About -->
  <!-- <script src="http://3.20.191.60/bundle.js" defer></script> -->
  <!-- Instructors -->
  <!-- <script src="http://54.176.19.199:3003/bundle.js" defer></script> -->
  <!-- Syllabus -->
  <!-- <script src="http://54.176.19.199:3005/bundle.js" defer></script> -->
  <!-- <script src="http://localhost:3005/bundle.js" defer></script> -->
  <!-- Images -->
  <!-- <script src="http://54.176.19.199:3006/bundle.js" defer></script> -->
  <!-- Reviews -->
  <!-- <script src="http://3.139.47.159/bundle.js" defer></script> -->
